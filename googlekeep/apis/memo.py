...
parser.add_argument('linked_image', required=False, type=FileStorage, help='메모 이미지', location='files')
parser.add_argument('is_deleted', required=False, type=inputs.boolean, help='메모 삭제 상태', location='form')
parser.add_argument('labels', action='split', help='라벨 내용 콤마 스트링', location='form')

put_parser = parser.copy() # PUT parser(복사)
put_parser.replace_argument('title', required=False, help='메모 제목', location='form')
put_parser.replace_argument('content', required=False, help='메모 내용', location='form')

get_parser = reqparse.RequestParser() # GET parser
get_parser.add_argument('page', required=False, type=int, help='메모 페이지 번호', location='args')
get_parser.add_argument('needle', required=False, help='메모 검색어', location='args')
get_parser.add_argument('is_deleted', required=False, type=inputs.boolean, help='메모 삭제 상태', location='args')
